  ...
  render() {
    return (
      <div className="card">
        ...
        <p className="delay--5">The primary road in {this.props.town.name} is {this.props.town.primaryRoad.name}. {this.props.town.primaryRoad.description}</p>
        <div className="card__locations">
          ...
          <p className="card__location-link delay--7">
            ...
            <span className="card__location-description">You can see on the left of {this.props.town.primaryRoad.name} a <strong>tavern</strong>, with a sign inscribed with <Link to={`/tavern`}>{this.props.tavern.business.name}</Link>.</span>
          </p>
          <p className="card__location-link delay--8">
            <IconAlchemist className="card__location-icon card__location-icon--cauldron  icon" />
            <span className="card__location-description">Further down {this.props.town.primaryRoad.name} is an <strong>alchemy lab</strong> named <Link to={`/alchemist`}>{this.props.alchemist.business.name}</Link>.</span>
          </p>
        </div>
      </div>
    );
